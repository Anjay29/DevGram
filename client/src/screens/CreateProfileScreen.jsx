...
let CreateProfileScreen = () => {
  ...
  const uploadImage = async (e) => {
    ...
    if (file.size > maxSize) {
      Swal.fire("File is too large!", "Maximum file size is 80 KB.", "error");
      return;
    }
  ...
  let submitCreateProfile = async (e) => {
    ...
    const payloadSize = new Blob([jsonPayload]).size; // Size in bytes
                ...
                <form onSubmit={submitCreateProfile}>
                  ...
                  <div className="form-group mb-4">
                    <input
                      ...
                      type="text"
                      className="form-control form-control-lg"
                      placeholder="Skills, Write in comma separated format like C,C++,.."
                    />
                  </div>
                  <div className="form-group mb-4">
                    <textarea
